...
@Data
@Entity
@Table(name = "voucherhist")
@EqualsAndHashCode(callSuper = false)
@NoArgsConstructor
@AllArgsConstructor
public class VoucherHistorico extends Auditable implements Serializable {/**
	 * 
	 */
	private static final long serialVersionUID = -8763762547733745476L;

	@Id
	@Column(name = "clave")
	private Long voucherHistoricoId;
