package eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.adapter;
...
import eterea.core.service.hexagonal.compras.proveedormovimiento.domain.ports.out.ProveedorMovimientoRepository;
import eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.entity.ProveedorMovimientoEntity;
import eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.mapper.ProveedorMovimientoMapper;
import eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.mapper.ResumenIvaComprasMensualMapper;
import eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.mapper.ResumenIvaComprasMensualPosicionMapper;
import eterea.core.service.hexagonal.compras.proveedormovimiento.infrastructure.persistence.repository.JpaProveedorMovimientoRepository;
