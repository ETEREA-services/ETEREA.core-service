...
public class HabitacionMovimientoController {
   ...
   public ResponseEntity<Boolean> isHabitacionReservada(@PathVariable Integer nroHabitacion, @PathVariable OffsetDateTime fechaIngreso, @PathVariable OffsetDateTime fechaSalida, @RequestParam(required = false) Long reservaIdExcluir) {
      return ResponseEntity.ok(service.isHabitacionReservada(nroHabitacion, fechaIngreso, fechaSalida, reservaIdExcluir));
   }
