...
class MakeFacturaProgramaDiaServiceTest {
        ...
        void testFacturaReservaGuardaTrackUuidEnEntidades() {
                ...
                when(empresaService.findLast()).thenReturn(java.util.Optional.of(empresa));
                ...
                when(reservaArticuloService.findAllByReservaId(reservaId))
                                .thenReturn(java.util.List.of(reservaArticulo));
                ...
                when(registraFacturaService.markReservaContextFacturada(any(), any(), any()))
                                .thenReturn(reservaContext);
                ...
                when(facturacionService.registraTransaccionFacturaProgramaDia(any(), any(), any(), any(), any(), any(),
                                any(), any(Track.class), anyBoolean()))
                ...
                verify(facturacionService).registraTransaccionFacturaProgramaDia(any(), any(), any(), any(), any(),
                                any(), any(), trackCaptorForFacturacion.capture(), anyBoolean());
